...
/RESTler/restler/Restler test --grammar_file /RESTler/Compile/grammar.py --dictionary_file /RESTler/Compile/dict.json --settings /RESTler/json/settings.json --no_ssl
...
if [ $? -eq 0 ]; then
    ...
    /RESTler/restler/Restler fuzz --grammar_file /RESTler/Compile/grammar.py --dictionary_file /RESTler/Compile/dict.json --settings /RESTler/json/settings.json --no_ssl
