...
# Load the JSON file
file_path = '/free5gc/5g-Microservice-testing/results_ni/Fuzz_evt_exposure/RestlerResults/experiment787286/bug_buckets/PayloadBodyChecker_500_2.json'
...
curl_command = f"""curl -X POST http://10.100.200.4:8000/namf-evts/v1/subscriptions \
